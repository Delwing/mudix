...
-- lockExit / hasExitLock are bound directly in LuaRuntime; the JS side already
-- parses both the 1-12 direction codes and the name forms ("north"/"n"/…) via
-- parseDirection, so no Lua wrapper is needed.
