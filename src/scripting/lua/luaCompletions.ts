...
const MUDLET_GLOBALS: Completion[] = [
    ...
    fn('debug',              '(text)',                    'Alias for debugc — logs to the browser devtools console. Mudlet name; bound here so ported scripts that call debug() rather than debugc() still work.'),
